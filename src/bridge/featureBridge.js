...
module.exports = {
  ...
  initialize() {
    ...
    // Ask
    ipcMain.handle('ask:sendQuestionFromAsk', async (event, userPrompt, options = {}) => {
      const { skipScreenshot = false } = options;
      return await askService.sendMessage(userPrompt, [], skipScreenshot);
    });
